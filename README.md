# Ethiopian Lutheran Liturgical Data Engine

The Ethiopian Lutheran Liturgical Data Engine is a robust, production-ready system designed to compute the Ethiopian church year and serve structured liturgical data for Christian worship applications. Originally conceived as a mathematical research project to understand the traditional Ethiopian computus, it has evolved into a comprehensive, open-source web platform and data foundation built by the community. It is designed to serve Ethiopian Lutheran churches, including the Lutheran Church of Ethiopia (LCE), the Ethiopian Evangelical Church Mekane Yesus (EECMY), and the Ethiopian Evangelical Lutheran Church (EELC).

**Please Note**: This is an unofficial, community-collaborated project aimed at providing an improved calendar system. It is not owned by or exclusively affiliated with any single denomination.
...
This is an open-source, community-collaborated effort. The core Bahire Hasab algorithm implementation was originally adapted from the open-source Kenat project by Henok Mikre. We remain deeply respectful of the original computus tradition of the Ethiopian Orthodox Tewahedo Church, from which this profound mathematical framework originates.
